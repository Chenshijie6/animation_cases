<template>
    <div class="main">
        ...
        <div class="shooting" v-for="(item, index) in 10">
            <div class="core"></div>
            <div class="trail"></div>
